...
| `layout` | `string` | none | Set to `home` to render a hero and features grid instead of the standard docs interface. See [Home Page](/reference/default-theme-home-page). |
