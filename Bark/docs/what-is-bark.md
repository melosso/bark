...
Most documentation tools are static site generators. You write Markdown, run a build, and the build spits out a folder of HTML files you then deploy somewhere. That's a fine workflow, but it puts a build pipeline between you editing a page and someone reading it.
