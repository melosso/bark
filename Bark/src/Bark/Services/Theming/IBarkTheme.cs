...
/// <summary>Styling only: CSS custom properties plus an optional component CSS fragment. Never navigation, content, routing or front matter.</summary>
public interface IBarkTheme
{
