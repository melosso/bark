...
public sealed record CliArguments(string? ExportDir, string? ExportBaseUrl, string? BasePath, string? Theme)
{
    public static CliArguments Parse(string[] args)
    {
        ...
        return new CliArguments(exportDir, exportBaseUrl, basePath, theme);
    }
}
