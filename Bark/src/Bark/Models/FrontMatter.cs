...
public sealed record FrontMatter
{
    ...
    /// <summary>Set to <c>"home"</c> to render <see cref="Hero"/>/<see cref="Features"/> instead
    /// of standard docs chrome (sidebar, TOC) -- vitepress's default-theme home page layout.</summary>
...
/// <summary>
/// Simplified vitepress hero schema: <c>image</c> and feature <c>icon</c> are plain strings (a
/// URL or an emoji), not vitepress's light/dark themeable-image object variant.
/// </summary>
